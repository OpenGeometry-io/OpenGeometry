...
Subtracts another boolean operand (such as an `Opening`) from this polygon and returns a renderable result mesh.
...
Try it in the browser: [Polygon demo](https://demo.opengeometry.io/shapes/polygon.html).
