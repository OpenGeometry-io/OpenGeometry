...
Subtracts another boolean operand (such as an `Opening`) from this wedge and returns a renderable result mesh.
...
Try it in the browser: [Wedge demo](https://demo.opengeometry.io/shapes/wedge.html).
