...
Subtracts another boolean operand (such as an `Opening`) from this sweep and returns a renderable result mesh.
...
Try it in the browser: [Sweep demo](https://demo.opengeometry.io/shapes/sweep.html).
