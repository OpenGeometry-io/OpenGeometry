...
Subtracts another boolean operand (such as an `Opening`) from this sphere and returns a renderable result mesh.
...
Try it in the browser: [Sphere demo](https://demo.opengeometry.io/shapes/sphere.html).
