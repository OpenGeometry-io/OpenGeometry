...
Subtracts another boolean operand (such as an `Opening`) from this cylinder and returns a renderable result mesh.
...
Try it in the browser: [Cylinder demo](https://demo.opengeometry.io/shapes/cylinder.html).
