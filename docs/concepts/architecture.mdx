...
**world**
`WorldGraph`: the kernel's single scene — shared definitions, nodes with parent-relative
transforms, clash/clearance queries, 2D projection, and scene-level export.
